...
export default function Contact() {
  ...
  return (
    <section className="relative py-32 px-6 lg:px-24 bg-[#050505] overflow-hidden min-h-screen flex flex-col items-center justify-center">
      ...
      {/* Background Decorative Glow (Monochrome) */}
      ...
      >
        <h2 className="text-zinc-500 font-black tracking-[0.2em] uppercase text-xs mb-3">Get in Touch</h2>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                {formik.touched.name && formik.errors.name && (
                  <p className="text-zinc-400 text-[10px] mt-1 ml-2 flex items-center gap-1"><AlertCircle size={12}/>{formik.errors.name}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {formik.touched.email && formik.errors.email && (
                  <p className="text-zinc-400 text-[10px] mt-1 ml-2 flex items-center gap-1"><AlertCircle size={12}/>{formik.errors.email}</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              {formik.touched.subject && formik.errors.subject && (
                  <p className="text-zinc-400 text-[10px] mt-1 ml-2 flex items-center gap-1"><AlertCircle size={12}/>{formik.errors.subject}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {formik.touched.message && formik.errors.message && (
                  <p className="text-zinc-400 text-[10px] mt-1 ml-2 flex items-center gap-1"><AlertCircle size={12}/>{formik.errors.message}</p>
              )}
            </div>
