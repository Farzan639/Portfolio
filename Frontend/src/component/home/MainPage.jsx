...
export default function MainPage({ scrollToSection }) {
  ...
  return (
    ...
    >
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-white/5 rounded-full blur-[120px] -z-10" />
        ...
        >
          <div className="relative w-[300px] h-[400px] lg:w-[420px] lg:h-[540px] flex items-center justify-center">
            ...
            <motion.div
              ...
              className="relative z-10 w-full h-full bg-zinc-900 border border-white/10 rounded-[24px] shadow-2xl overflow-hidden p-3"
            >
